...
func main() {
	...
	pflag.StringVar(&dockerfilesDir, "dockerfile-dir", "openshift/ci-operator/knative-images", "Dockerfiles output directory for project images")
	pflag.StringVar(&dockerfilesBuildDir, "dockerfile-build-dir", "openshift/ci-operator/build-image", "Dockerfiles output directory for build image")
	pflag.StringVar(&dockerfilesTestDir, "dockerfile-test-dir", "openshift/ci-operator/knative-test-images", "Dockerfiles output directory for test images")
