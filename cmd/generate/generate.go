...
func main() {
	...
	pflag.StringVar(&params.Output, "output", filepath.Join(wd, "openshift"), "Output directory")
	pflag.StringVar(&params.ProjectFilePath, "project-file", filepath.Join(wd, "openshift", "project.yaml"), "Project metadata file path")
